        ...
        <div className={styles.header}>
                ...
                <div className={styles.headerDescription}>
                    <div className={styles.descriptionEdit}>
                        ...
                        <div className={styles.descriptionEditButton}>
                            <a className={styles.editButton} href="fjf">Редактировать профиль</a>
                        </div>
                    ...
                    <div className={styles.descriptionPosts}>
                        <div><b>36</b> публикаций</div>
                        <div><b>184</b> подписчиков</div>
                        <div><b>194</b> подписок</div>
                    </div>
            ...
            <div className={styles.menuMain}>
                <a className={styles.menuLink} href='sdfg'>
                    <svg aria-label="" class="_8-yf5 " color="#8e8e8e" fill="#8e8e8e" height="12" role="img" viewBox="0 0 24 24" width="12"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
                    <Link to='/saves'><div className={styles.menuText}>СОХРАНЕННОЕ</div></Link>
                </a>
            </div>
        </div>
        </>
