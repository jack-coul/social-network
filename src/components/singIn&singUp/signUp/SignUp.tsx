...
const SignUp = () => {
  ...
  const handleGetDataUser = (e: ChangeEvent<HTMLInputElement>) => {
    const { name, value } = e.target;
    setRegisterData({ ...registerData, [name]: value });
  };

  const handleSignUp = async () => {
    if (registerData.password === passwordTwo) {
      if (!!formEmpty) {
          ...
          <div className="form-content">
            <div className="form-group">
              ...
              <input
                ...
                onChange={(e) => handleGetDataUser(e)}
              />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              <label htmlFor="cpassword">логин</label>
              <input
                id="cpassword"
                type="text"
                name="login"
